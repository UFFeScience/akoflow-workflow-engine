...
import (
	...
	"github.com/UFFeScience/akoflow/internal/cli/application/install_kubernetes_local_service"
...
const (
	...
	mainInstallAkoflowKubeAdmin = "kubectl apply -f https://raw.githubusercontent.com/UFFeScience/akoflow/refs/heads/AKF-21/internal/infrastructure/assets/resource/akoflow-dev-dockerdesktop.yaml &&  kubectl create token akoflow-server-sa --duration=800h --namespace=akoflow"
)
