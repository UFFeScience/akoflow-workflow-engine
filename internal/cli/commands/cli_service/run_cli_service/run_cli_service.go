...
import (
	...
	"github.com/UFFeScience/akoflow/internal/cli/application/dispatch_to_server_run_workflow_service"
	"github.com/UFFeScience/akoflow/internal/cli/application/flag_validator_service"
)
...
func (r *RunCliService) Run() {
	...
	dispatchToServerRunWorkflowService.
		...
		SetPort(*port).
		SetFile(*fileYaml)
	if err := dispatchToServerRunWorkflowService.Run(); err != nil {
		panic(err)
	}
}
