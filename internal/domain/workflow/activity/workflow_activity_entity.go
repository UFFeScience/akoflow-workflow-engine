...
type WorkflowActivities struct {
	...
	ResourceSelector string   `yaml:"resourceSelector"`
...
// ActivitySchedule represents the persisted assignment used by the execution
// adapters. It is an application entity, not a database schema descriptor.
...
func (wfa WorkflowActivities) GetResourceSelector() map[string]string {
	selector := wfa.ResourceSelector
...
func (wfa WorkflowActivities) HasResourceSelector() bool {
	return wfa.ResourceSelector != ""
}
